...
import { Activity, Brain, Heart, Trees as Lungs, Microscope } from "lucide-react"
  ...
  return (
    ...
    <div className="flex flex-col items-center justify-center min-h-screen bg-gradient-to-b from-gray-900 to-gray-800 text-white p-4">
      ...
      <div className="w-full max-w-3xl bg-gray-900 rounded-xl shadow-2xl p-8">
        <h1 className="text-3xl font-bold mb-6 text-blue-400 text-center">Medical Image Generator</h1>
        ...
        <div className="mb-6">
            ...
            {Object.entries({
              ...
              <button
                ...
                className={`p-2 rounded-full ${
                  activeTab === key ? "bg-blue-500 text-white" : "bg-gray-700 text-gray-400"
          ...
          <p className="text-sm text-gray-400 text-center">{tabContent[activeTab]}</p>
        </div>
